...
export default function App() {
  ...
  return (
    <ImageBackground source={blurBg} className='relative flex-1 items-center bg-gray-900 px-8 py-10' imageStyle={{
      ...
      <Text className='text-center font-body text-gray-50'>Feito com 💜 no NLW da Rocketseat</Text>
